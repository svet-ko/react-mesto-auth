...
function Login({ onLogin }) {
  ...
  return (
    <form className="form form_type_sign" onSubmit={handleFormSubmit}>
      ...
      <button type="submit" className={`button form__submit-button form__submit-button_type_sign ${isFormValid ? '' : 'form__submit-button_inactive'}`} disabled={!isFormValid}>Войти</button>
    </form>
  )
}
